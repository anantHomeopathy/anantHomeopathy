...
Hosted on GitHub Pages: `https://<your-username>.github.io/anant-homeopathy-clinic/`
...
### First-Time Setup (પ્રથમ વખત)

1. **GitHub account** બનાવો [github.com](https://github.com) પર (જો ન હોય)
2. **New repository** બનાવો:
   - **+** બટન (ઉપર જમણે) > **New repository**
   - નામ: `anant-homeopathy-clinic`
   - **Public** રાખો
   - **Create repository** ક્લિક કરો
3. **ફાઈલો અપલોડ** કરો:

**Method A - GitHub website દ્વારા (સૌથી સરળ):**
   - Repository પેજ પર **"uploading an existing file"** ક્લિક કરો
   - બધી ફાઈલો અને ફોલ્ડરો drag & drop કરો
   - **Commit changes** ક્લિક કરો

**Method B - Git command line:**
```bash
cd /path/to/Anant_homeopathy_clinic
git init
git add .
git commit -m "Initial website upload"
git branch -M main
git remote add origin https://github.com/YOUR_USERNAME/anant-homeopathy-clinic.git
git push -u origin main
```

4. **GitHub Pages enable** કરો:
   - Repository > **Settings** > **Pages** (left sidebar)
   - Source: **Deploy from a branch**
   - Branch: **main**, Folder: **/ (root)**
   - **Save** ક્લિક કરો
   - 1-2 મિનિટ રાહ જુઓ, સાઈટ live થઈ જશે!

### Website અપડેટ કરવી

ફાઈલમાં ફેરફાર કર્યા પછી:

**Method A - GitHub website:**
1. Repository પર જાઓ
2. ફાઈલ શોધો > **Edit** (pencil icon) ક્લિક કરો
3. ફેરફાર કરો > **Commit changes** ક્લિક કરો
...
Website 1-2 મિનિટમાં આપમેળે અપડેટ થશે.
